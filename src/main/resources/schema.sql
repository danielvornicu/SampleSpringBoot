...
CREATE TABLE ADRESSE (ID NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,   LIGNE1 VARCHAR2(255),   LIGNE2 VARCHAR2(255),   CODE_POSTAL NUMBER,   VILLE VARCHAR2(255) ); 
CREATE TABLE CLIENT (ID NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,   PRENOM VARCHAR2(255),   NOM VARCHAR2(255),   ADRESSE_ID NUMBER ); 
CREATE TABLE COMMANDE (ID NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,   NOMBRE_PRODUITS NUMBER,   MONTANT NUMBER,   DATE_COMMANDE DATE,   CLIENT_ID NUMBER );
