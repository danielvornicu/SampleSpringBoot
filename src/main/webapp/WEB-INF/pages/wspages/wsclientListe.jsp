...
<spring:url var="createUrl" value="wsclient/new" />

<div>
    <h1>
        <spring:message code="liste.clients.soap.titre" />
    </h1>
</div>
...
<table>
    ...
    <c:forEach items="${listeClients}" var="client">
        <tr>
            ...
            <td>${client.prenom}</td>
            <td>
                <a href="wsclient/${client.id}"><spring:message code="liste.action.consulter"/></a> |
                <a href="wsclient/${client.id}/edit"><spring:message code="liste.action.modifier"/></a> |
                <a href="wsclient/${client.id}/delete"><spring:message code="liste.action.supprimer"/></a>
            </td>
        </tr>
    </c:forEach>
    </tbody>
